...
// String.prototype.yell = function(){
//     return `OMG! ${this.toLocaleUpperCase()}!!! AGHGHGHGH!`;
// };
...
// Color.prototype.hex = function() {  // rgb to hex attention to detail dingus
//     const { r, g, b } = this;
//     return '#' + ((1 << 24) + (r << 16) + (g << 8) + b).toString(16).slice(1);
...
class Cat extends Pet{  // adds pet constructor class  to the dog and cat class
